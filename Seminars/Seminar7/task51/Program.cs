...
// Матрица может быть прямоугольный
...
int[,] GetMatrix(int rowsCount, int columnsCount, int leftRange = 0, int rightRange = 9)  //метод заполнения н мерного массива
{
...
int m = 3;// ReadNumber("Введите колличество строк");
